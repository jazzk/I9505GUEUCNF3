...
./mkbootimg --kernel $KERNEL_DIR/arch/arm/boot/zImage --ramdisk $RAMFS_TMP.cpio.gz --cmdline "console=null androidboot.hardware=jgedlte user_debug=31 msm_rtb.filter=0x3F ehci-hcd.park=3" -o $WORKING_DIR/boot.img --base "0x80200000" --ramdiskaddr "0x82200000"
